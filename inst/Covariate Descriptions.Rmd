---
title: 'Covariate Names + Definitions : Package WhaleInjuryCovariates()'
author: "jim.carretta@noaa.gov"
<<<<<<< HEAD
date: "7/27/2021"
=======
date: "7/28/2021"
>>>>>>> 78961e0 (Covariate Description file added)
...
```
# Example covariate coding from narratives.
# Covariates are identified from injury narratives (data.frame field must be named 'Narrative'),
# using function grepl to assign TRUE/FALSE to presence/absence of words or phrases in narrative.
# Covariates are then coded numerically as 1/0, aligned with their TRUE/FALSE value.

# Evidence of a health decline? Search field 'Narrative' for words/phrases associated with health declines.

    decline = grepl(" abnormal|chronic|deteriorat|fair|compromise|scoliosis|deform|cyamid|
    lice|lethargic|lesion|discolor|diatom|poor cond|poor health|poor body|poor over|
    poor skin|rake|skin|slough|thin |emaciated|malnourish|underweight|
    starv|mobility", LargeWhaleData$Narrative, ignore.case=T)
